...
TRANSLATIONS = {
    "en": {
        ...
        "search_placeholder":   "🔍 Search by category, note or tag...",
        "search":               "Search",
        "all":                  "All",
        "expense":              "Expense",
        ...
        "import_csv_sub":       "Import transactions from a bank statement or other CSV file.",
        "choose_file":          "📂 Choose CSV file",
        "import_file_info":     "Found {} rows in file.",
        "column_mapping":       "Column mapping",
        "date_column":          "Date column",
        "amount_column":        "Amount column",
        "note_column":          "Description column",
        "skip_column":          "— Skip —",
        ...
        "tags_placeholder":       "#vacation #work #gift",
        "tags":                   "Tags",
        ...
        "total_income_year":    "Total income",
        "total_expense_year":   "Total expenses",
        "savings_rate":         "Savings rate",
        "best_month":           "Best month",
        "worst_month":          "Worst month",
        "highest_income":       "Top income",
        "highest_expense":      "Top expense",
        "month_comparison":     "📅 Month Comparison",
        "month_col":            "Month",
        "change_vs_prev":       "vs prev",
        "average":              "Average",
        ...
        # ── Onboarding ────────────────────────────────────────────────────────
        "onboarding_subtitle":  "Your personal budget, fully offline.",
        "choose_language":      "Choose your language",
        "change_later_settings":"You can always change this in Settings.",
        "next_step":            "Continue →",
        "back":                 "Back",
        "setup_profile":        "Set up your profile",
        "setup_profile_sub":    "Tell us a bit about yourself.",
        "name_placeholder":     "e.g. Alex",
        "name_required":        "Please enter your name.",
        "all_set":              "You're all set!",
        "all_set_sub":          "Everything is ready. Let's get started.",
    ...
    "ru": {
        ...
        "search_placeholder":   "🔍 Поиск по категории, заметке или тегу...",
        "search":               "Найти",
        "all":                  "Все",
        "expense":              "Расход",
        ...
        "import_csv_sub":       "Загрузите транзакции из банковской выписки или CSV файла.",
        "choose_file":          "📂 Выбрать CSV файл",
        "import_file_info":     "Найдено {} строк в файле.",
        "column_mapping":       "Сопоставление колонок",
        "date_column":          "Колонка даты",
        "amount_column":        "Колонка суммы",
        "note_column":          "Колонка описания",
        "skip_column":          "— Пропустить —",
        "date_format":          "Формат даты",
        "preview":              "Предпросмотр",
        "import_btn":           "🚀 Импортировать {} транзакций",
        "import_complete":      "Импорт завершён",
        "import_result":        "Импортировано: {}\nПропущено: {}\nОшибок: {}",
        ...
        "tags_placeholder":       "#отпуск #работа #подарок",
        "tags":                   "Теги",
        ...
        # ── Year Statistics ───────────────────────────────────────────────────
        "year_stats":           "📊 Статистика за год — {}",
        "total_income_year":    "Всего доходов",
        "total_expense_year":   "Всего расходов",
        "savings_rate":         "Доля накоплений",
        "best_month":           "Лучший месяц",
        "worst_month":          "Худший месяц",
        "highest_income":       "Макс. доход",
        "highest_expense":      "Макс. расход",
        "month_comparison":     "📅 Сравнение месяцев",
        "month_col":            "Месяц",
        "change_vs_prev":       "vs пред.",
        "average":              "Среднее",
        ...
        # ── Onboarding ────────────────────────────────────────────────────────
        "onboarding_subtitle":  "Личный бюджет. Полностью офлайн.",
        "choose_language":      "Выберите язык",
        "change_later_settings":"Вы всегда можете изменить это в Настройках.",
        "next_step":            "Далее →",
        "back":                 "Назад",
        "setup_profile":        "Настройте профиль",
        "setup_profile_sub":    "Расскажите немного о себе.",
        "name_placeholder":     "например, Алекс",
        "name_required":        "Пожалуйста, введите имя.",
        "all_set":              "Всё готово!",
        "all_set_sub":          "Можно начинать. Добро пожаловать!",
        "get_started":          "🚀 Начать",
    ...
    "de": {
        ...
        "search_placeholder":   "🔍 Suche nach Kategorie, Notiz oder Tag...",
        "search":               "Suchen",
        "all":                  "Alle",
        "expense":              "Ausgabe",
        ...
        "import_csv_sub":       "Importieren Sie Transaktionen aus einem Kontoauszug oder einer CSV-Datei.",
        "choose_file":          "📂 CSV-Datei auswählen",
        "import_file_info":     "{} Zeilen in der Datei gefunden.",
        "column_mapping":       "Spaltenzuordnung",
        "date_column":          "Datumsspalte",
        "amount_column":        "Betragsspalte",
        "note_column":          "Beschreibungsspalte",
        "skip_column":          "— Überspringen —",
        "date_format":          "Datumsformat",
        "preview":              "Vorschau",
        "import_btn":           "🚀 {} Transaktionen importieren",
        "import_complete":      "Import abgeschlossen",
        "import_result":        "Importiert: {}\nÜbersprungen: {}\nFehler: {}",
        ...
        "tags_label":             "Tags (optional)",
        "tags_placeholder":       "#urlaub #arbeit #geschenk",
        "tags":                   "Tags",
        ...
        # ── Year Statistics ───────────────────────────────────────────────────
        "year_stats":           "📊 Jahresstatistik — {}",
        "total_income_year":    "Gesamteinnahmen",
        "total_expense_year":   "Gesamtausgaben",
        "savings_rate":         "Sparquote",
        "best_month":           "Bester Monat",
        "worst_month":          "Schlechtester Monat",
        "highest_income":       "Höchste Einnahmen",
        "highest_expense":      "Höchste Ausgaben",
        "month_comparison":     "📅 Monatsvergleich",
        "month_col":            "Monat",
        "change_vs_prev":       "vs Vormonat",
        ...
        # ── Onboarding ────────────────────────────────────────────────────────
        "onboarding_subtitle":  "Ihr persönliches Budget, komplett offline.",
        "choose_language":      "Wählen Sie Ihre Sprache",
        "change_later_settings":"Sie können dies jederzeit in den Einstellungen ändern.",
        "next_step":            "Weiter →",
        "back":                 "Zurück",
        "setup_profile":        "Profil einrichten",
        "setup_profile_sub":    "Erzählen Sie uns ein wenig über sich.",
        "name_placeholder":     "z.B. Alex",
        "name_required":        "Bitte geben Sie Ihren Namen ein.",
        "all_set":              "Alles bereit!",
        "all_set_sub":          "Alles ist eingerichtet. Legen wir los!",
